<template>
  ...
  <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="flex flex-col justify-center items-center">
      <button @click="login" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline  mb-2" type="button">
        Login
      </button>
